---
lab:
  title: 스윕 작업을 사용하여 하이퍼 매개 변수 튜닝 수행
---

# 스윕 작업을 사용하여 하이퍼 매개 변수 튜닝 수행

하이퍼 매개 변수는 모델이 학습되는 방식에 영향을 주지만 학습 데이터에서 파생될 수 없는 변수입니다. 모델 학습에 최적의 하이퍼 매개 변수 값을 선택하는 것은 어려울 수 있으며 일반적으로 많은 시행 착오가 수반됩니다.

이 연습에서는 Azure Machine Learning을 사용하여 여러 학습 시험을 병렬로 수행하여 하이퍼 매개 변수를 튜닝합니다.
