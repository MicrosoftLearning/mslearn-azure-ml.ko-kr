---
lab:
  title: Azure Machine Learning의 환경 작업
---

# Azure Machine Learning의 환경 작업

Notebook 및 스크립트를 실행하려면 필요한 패키지가 설치되어 있는지 확인해야 합니다. 환경을 사용하면 컴퓨팅에서 코드를 실행하는 데 사용해야 하는 런타임 및 Python 패키지를 지정할 수 있습니다.

이 연습에서는 Azure Machine Learning 컴퓨팅을 사용하여 기계 학습 모델을 학습할 때 환경에 대해 알아보고 이를 사용하는 방법을 알아봅니다.
...
작업 영역 및 필요한 컴퓨팅 리소스를 만든 경우 Azure Machine Learning 스튜디오 열고 랩 자료를 복제할 수 있습니다. 
...
Python SDK를 사용하여 환경을 만들고 관리하는 코드는 Notebook에 제공됩니다.
