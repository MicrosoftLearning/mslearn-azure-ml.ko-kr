...
Notebooks와 스크립트를 실행하려면 필수 패키지가 설치되어 있는지 확인해야 합니다. 환경을 사용하면 코드를 실행하기 위해 컴퓨팅에서 사용해야 하는 런타임 및 Python 패키지를 지정할 수 있습니다.

이 연습에서는 Azure Machine Learning 컴퓨팅을 사용하여 Machine Learning 모델을 학습할 때 환경과 이를 사용하는 방법에 대해 알아봅니다.
...
작업 영역과 필요한 컴퓨팅 리소스를 만들었으면 Azure Machine Learning 스튜디오를 열고 랩 자료를 복제할 수 있습니다. 
...
Python SDK를 사용하여 환경을 만들고 관리하는 코드는 Notebook으로 제공됩니다.
