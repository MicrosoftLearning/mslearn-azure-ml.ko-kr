...
애플리케이션에서 모델을 사용하고 실시간 예측을 얻으려면 관리형 온라인 엔드포인트에 모델을 배포해야 합니다. 환경을 정의하거나 점수 매기기 스크립트를 만들 필요가 없으므로 MLflow 모델을 쉽게 배포할 수 있습니다.
...
1. **Labs/11/Deploy를 온라인 endpoint.ipynb** Notebook에 엽니다.
