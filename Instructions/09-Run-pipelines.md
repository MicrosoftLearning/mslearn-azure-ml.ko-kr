...
1. 스크립트가 완료될 때까지 기다리세요. 일반적으로 약 5~10분이 걸립니다.
    ...
    <ol>
        ...
        <li>https://github.com/MicrosoftLearning/mslearn-azure-ml/raw/refs/heads/main/Labs/09/data/diabetes.csv에서 학습 데이터를 다운로드합니다</li>
        <li>Azure Machine Learning 스튜디오에서 <b>데이터</b> 페이지로 이동하여<b>+ 만들기</b>를 선택합니다.</li>
        <li>데이터 자산의 이름을 <b>diabetes-data</b>로 지정하고 <b>파일(uri_파일)</b> 유형이 선택되었는지 확인합니다. <b>다음</b>을 선택합니다.</li>
        <li>데이터 원본으로 <b>로컬 파일에서</b>를 선택한 다음 <b>다음</b>을 선택합니다.</li>
        <li>대상 스토리지 유형 및 데이터 저장소로 각각 <b>Azure Blob Storage</b> 및 <b>workspaceblobstore</b>가 선택되어 있는지 확인합니다. <b>다음</b>을 선택합니다.</li>
        <li>이전에 다운로드한 .csv 파일을 업로드한 다음 <b>다음</b>을 선택합니다.</li>
        <li>데이터 자산의 설정을 검토한 다음 <b>만들기</b>를 선택합니다.</li>
    </ol>
    </details>
...
1. **Labs/09/Run a pipeline job.ipynb** Notebook을 엽니다.
