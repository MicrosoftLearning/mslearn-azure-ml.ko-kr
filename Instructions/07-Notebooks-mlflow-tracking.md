...
여러 모델을 실험하고 학습하여 새 데이터 과학 프로젝트를 시작하는 경우가 많습니다. 작업을 추적하고 학습하는 모델 및 모델 수행 방법에 대한 개요를 유지하려면 MLflow 추적을 사용할 수 있습니다.

이 연습에서는 컴퓨팅 인스턴스에서 실행되는 Notebook 내에서 모델 학습을 기록하는 MLflow를 수행합니다.
...
1. 터미널에서 터미널에서 다음 명령을 실행하여 컴퓨팅 인스턴스에 Python SDK 및 MLflow 라이브러리를 설치합니다.
...
1. **MLflow.ipynb** Notebook을 사용하여 Labs/07/Track 모델 학습을 엽니다.
