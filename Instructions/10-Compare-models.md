...
모델을 학습한 후에는 모델을 평가하여 모델이 예상대로 수행되고 있는지 여부를 살펴볼 수 있습니다. 성능 메트릭 옆에는 고려할 수 있는 다른 요소가 있습니다. Azure Machine Learning의 책임 있는 AI 대시보드를 사용하면 데이터와 모델의 예측을 분석하여 편견이나 불공정성을 식별할 수 있습니다.
...
이제 필요한 모든 리소스가 있으므로 Notebook을 실행하여 기본 제공 책임 AI 구성 요소를 검색하고, 파이프라인을 만들고, 파이프라인을 제출하여 책임 있는 AI 대시보드를 생성할 수 있습니다.
