---
lab:
  title: 책임 있는 AI 대시보드 만들기 및 탐색
---

# 책임 있는 AI 대시보드 만들기 및 탐색

모델을 학습한 후에는 모델을 평가하여 예상대로 성능을 발휘하는지 알아볼 수 있습니다. 성능 메트릭 외에도 고려할 수 있는 다른 요소가 있습니다. Azure Machine Learning의 책임 있는 AI 대시보드를 사용하면 데이터와 모델의 예측을 분석하여 바이어스 또는 불공평성을 식별할 수 있습니다.
...
이제 필요한 리소스가 모두 준비되었으므로 Notebook을 실행하여 기본 제공된 담당 AI 구성 요소를 검색하고, 파이프라인을 만들고, 파이프라인을 제출하여 담당 AI 대시보드를 만들 수 있습니다.

1. **Labs/10/Create Responsible AI dashboard.ipynbipynb** Notebook을 엽니다.
